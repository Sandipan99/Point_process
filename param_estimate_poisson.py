import os
import sys
from param_estimate_univar_hawkes import RMSE,MAE,obtain_node_arrivals,select_node_arrivals,compare
import numpy as np
import time
...
def estimate_poisson(ver):
	...
	for i in xrange(len(node)):
		...
		event,event_or = select_node_arrivals(node_arr,node,i)
